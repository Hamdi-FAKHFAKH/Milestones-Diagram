var MilestonesDiagram = (function () {
    'use strict';
    ...
    class Bar {
        ...
        draw() {
            ...
            if (this.gantt.options.view_mode == VIEW_MODE.DAY) { this.draw_label(); }
        ...
        draw_label() {
            createSVG('text', {
                ...
                innerHTML: this.task.name.toUpperCase(),
                class: 'bar-label',
                append_to: this.bar_group,
            });
        ...
        update_handle_position() {
            ...
            this.handle_group
                ...
                this.handle_group
                    .querySelector('.handle.left').setAttribute('x', bar.getX() + 1);
            this.handle_group
                .querySelector('.handle.right') && this.handle_group
    ...
    class MilestonesDiagram {
        ...
        setup_wrapper(element) {
            ...
            if (element instanceof HTMLElement) {
                ...
                throw new TypeError(
                    'Frappé MilestonesDiagram only supports usage of a string CSS selector,' +
        ...
        make_grid_highlights() {
            ...
            if (this.view_is(VIEW_MODE.YEAR)) {
                const diff = date_utils.diff(date_utils.today(), this.gantt_start, 'day');
                x = (diff * this.options.column_width) / 360;
                const y = 0;
                const width = this.options.column_width / 30;
                const height =
                    (this.options.bar_height + this.options.padding) *
    ...
    MilestonesDiagram.VIEW_MODE = VIEW_MODE;

    function generate_id(task) {
        return task.name + '_' + Math.random().toString(36).slice(2, 12);
    }

    return MilestonesDiagram;
